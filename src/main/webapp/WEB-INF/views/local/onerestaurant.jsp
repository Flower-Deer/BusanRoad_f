...
<body style="font-family: 'GmarketSansMedium';" >
  ...
  <!-- 헤더 -->
    <header style="font-family: 'GmarketSansMedium';" class="d-flex flex-wrap align-items-center justify-content-md-between border-bottom">
      	<a href="../main/main.jsp">
			<img src=../resources/img/logo2.png class="himg">
		</a>
		
      	<ul class="nav col-12 col-md-auto mb-2 mb-md-0" style="font-family: 'GmarketSansMedium';">
               ...
               <!-- Post content-->
                    <article>
                        ...
                        <header class="mb-4" id="article" style="text-align: center; padding-top: 60px;">
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1" style="font-weight: 700; font-size:50px;">${one2.name}</h1>
                            <!-- Post meta content-->
                            <div class="text-muted fst-italic mb-2" style="font-weight: 300; font-size:30px; " >${one2.category}</div>  
                            <hr>
                            <br>
                        </header>
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade" style=" margin-bottom: 30px;">
  							<div class="carousel-inner">
    							<div class="carousel-item active">
     								<img style="width:400px; height:600px; border-radius: 0.25rem !important;" src="../resources/img/${one2.img}" class="d-block w-100" alt="...">
    							</div>
    							<div class="carousel-item">
      								<img style="width:400px; height:600px; border-radius: 0.25rem !important;" src="../resources/img/${one2.img2}" class="d-block w-100" alt="...">
    							</div>
    							<div class="carousel-item">
      								<img style="width:400px; height:600px; border-radius: 0.25rem !important;" src="../resources/img/${one2.img3}" class="d-block w-100" alt="...">
    							</div>
  							</div>
                        ...
                        <table class="local-table">
						    <tr id="local-table-tr">						
						        ...
						        <td id="local-table-content" >${one2.address}</td>						
						        <td id="local-table-title">휴무</td>						
						        <td id="local-table-content">${one2.off}</td>						
						    </tr>
						
						    <tr id="local-table-tr">						
						        <td id="local-table-title">영업 시간</td>						
						        <td id="local-table-content">${one2.time}</td>
								<td id="local-table-title">대표 메뉴</td>						
						        <td id="local-table-content">${one2.menu}</td>
						    </tr>
							
							 <tr  id="local-table-tr">						
						        <td id="local-table-title">주차 시설 </td>						
						        <td id="local-table-content">${one2.park}</td>								
						    </tr>
						</table>
