...
<div class="local-row"  style="font-family: 'GmarketSansMedium'; ">
                    <article>
                        ...
                        <header class="mb-4" id="article" style="text-align: center; ">
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1" style="font-weight: 700; font-size:50px;">${one.name}</h1>
                            <!-- Post meta content-->
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade" style=" margin-bottom: 30px;">
  							<div class="carousel-inner">
    							<div class="carousel-item active">
     								<img style="width:400px; height:600px; border-radius: 0.25rem !important;" src="../resources/img/${one.img}" class="d-block w-100" alt="...">
    							</div>
    							<div class="carousel-item">
      								<img style="width:400px; height:600px; border-radius: 0.25rem !important;" src="../resources/img/${one.img2}" class="d-block w-100" alt="...">
    							</div>
    							<div class="carousel-item">
      								<img style="width:400px; height:600px; border-radius: 0.25rem !important;" src="../resources/img/${one.img3}" class="d-block w-100" alt="...">
    							</div>
  							</div>
                        ...
                        <table class="local-table" >
                        	<tr id="local-table-tr">						
								<td id="local-table-title" colspan="4"> 소개</td>						
						    </tr>
						    
						    <tr id="local-table-tr" >													
						        <td id="local-table-content" colspan="4">${one.content}</td>
						    </tr>
