...
<body>
	...
	<!-- 헤더 -->
	<header
		class="d-flex flex-wrap align-items-left justify-content-md-between border-bottom">
	...
	<div class="intro" style="font-family: 'GmarketSansMedium';">
		<h1 style="font-weight: 700; text-align: center;">관광지 조회, 수정, 삭제</h1>
		<br>
		<hr>
		<br>
		<h3 style="text-align: center;">관광지 명 조회후 수정, 삭제</h3>
	</div>
	...
	<div class="side-menu">
		...
		<ul class="list-unstyled ps-0">
			...
			<li class="mb-4">
				<button id="local-li"
					class="btn btn-toggle d-inline-flex align-items-left rounded border-0 collapsed"
			...
			<li class="mb-4">
				<button id="local-li"
					class="btn btn-toggle d-inline-flex align-items-left rounded border-0 collapsed"
					aria-expanded="true" onclick="location.href='localEdit_acco_sjsp'">
					숙박 조회</button>
				<hr style="border-style: dashed;">
			</li>
	...
	<div
		...
		<div style="float: right; margin-top: 120px;">
			<form method="post" action="${path}/www/tour_update?num=${vo.num}">
				...
				<table style="width: 800px; font-size: 20px;">
					...
					<tr style="height: 50px;">
						...
						<td><input style="width: 600px; font-size: 15px;" type="text"
							id="category" name="category" value="${vo.category}"></td>
					</tr>
					<tr style="height: 50px;">
					...
					<tr align="right">
						<td colspan="2"><button class="btn btn-outline-dark mt-auto"
							type="submit">수정</button> <button class="btn btn-outline-dark mt-auto"
							type="button" onclick="location.href='localEdit_tour_s.jsp'">취소</button></td>
					</tr>
				</table>
			</form>
		</div>
