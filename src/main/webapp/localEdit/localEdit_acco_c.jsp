...
<body>
	...
	<div class="intro" style="font-family: 'GmarketSansMedium';">
		<h1 style="font-weight: 700; text-align: center;">숙박 등록</h1>
		<br>
		<hr>
		<br>
		<h3 style="text-align: center;">숙박 정보 등록</h3>
	</div>
	...
	<div
		...
		<div style="float: right; margin-top: 120px;">
			<form method="post" action="acco_insert">
				<table style="width: 800px; font-size: 20px;">
					<tr style="height: 50px;">
						<td align="left" style="width: 342px;">이름</td>
						<td align="left"><input
					...
					<tr style="height: 50px;">
						<td align="left">부대시설</td>
						<td align="left"><input
							style="width: 600px; font-size: 15px;" type="text" id="etc"
							name="etc"></td>
					</tr>
					<tr style="height: 50px;">
						<td align="left">웹사이트</td>
						<td align="left"><input
							style="width: 600px; font-size: 15px;" type="text" id="website"
							name="website"></td>
					</tr>
					<tr style="height: 50px;">
					...
					<tr align="right">
						<td colspan="2">
							<button type="submit" class="btn btn-outline-dark mt-auto">등록</button>
							<button type="reset" class="btn btn-outline-dark mt-auto">취소</button>
						</td>
					</tr>
				</table>
			</form>
