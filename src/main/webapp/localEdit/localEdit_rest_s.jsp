	...
	<div class="container">
		...
		<div>
			...
			<div>
				...
				<div>
					<div>
						<a href="#" onclick="location.href='localEdit_rest_c.jsp'"><button>등록</button></a>
					</div>
					<div>
						<a href="#" onclick="location.href='localEdit_rest_s.jsp'"><button>조회</button></a>
					</div>
				</div>
				<div>
					<p>음식점 정보 등록하는 페이지 입니다</p>
					<form action="localEditV/insert">
						<table style="width: 1050px; font-size: 20px;">
							...
							<tr align="right">
								<td colspan="2">
									<button type="submit"
										onclick="javascript: form.action='localEditV/update3';">수정</button>

									<button type="submit"
										onclick="javascript: form.action='localEditV/delete3';">삭제</button>
